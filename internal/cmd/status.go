...
import (
	...
	"github.com/kzgrzendek/nova/internal/status"
...
func runStatus(cmd *cobra.Command, verbose bool) error {
	...
	if sysStatus.Cluster.Running {
		displayDeploymentsStatus(sysStatus.Deployments, verbose)
	}
...
func displayDeploymentsStatus(deployments *status.DeploymentsStatus, verbose bool) {
	ui.Info("")
